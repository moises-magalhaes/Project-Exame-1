...
async function callNext() {
    ...
    function createHtml(pageInfo){
        ...
        nextLaunchesContainer.innerHTML +=`<div class="subbox">
        <div class="title"><h3>Next Launches</h3></div>
        <div class="name"><h2>${pageInfo.name}</h2></div>
        <div class="date"><p>${pageInfo.date_local}</p></div>

            <div class="flight-number">
            <p>Flight Number: ${pageInfo.flight_number}</p>
        </div>
            <div class="image">
            </div>
            </div>`;
